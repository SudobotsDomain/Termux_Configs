#create the file
nano extract_scatter.sh
#file contents
#!/bin/bash

# Define the path to the gzip file
GZIP_FILE="/path/to/your/scatterfile.gz"
...
chmod +x extract_scatter.sh
./extract_scatter.sh
GZIP_FILE="/home/user/scatterfile.gz"
...
echo "Scatter file has been extracted to ${EXTRACT_PATH}scatterfile.txt"
echo "Hardware profiles #!/bin/bash
...
echo "Boot image has been copied and compressed to ${GZIP_FILE}"
echo "Scatter file has been extracted to ${EXTRACT_PATH}scatterfile.txt"
echo "Hardware profiles have been saved to ${HARDWARE_PROFILES}"have been saved to ${HARDWARE_PROFILES}"
#!/bin/bash
